...
local item = {'ring', 'goldNecklace', 'laptop', 'samsungS10', 'rolex', 'camera'}
...
local burglaryPlaces = {
  ...
  ["Forum Dr"] = {
    door = 2,
    locked = true,
    pos = { x = -32.99, y = -1446.42, z = 31.89, h = 269.24 },  -- door coords
    inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = -32.53, y = -1446.11, z = 31.89, h = 269.75 }, -- The animation position
    doorTime = {}
  }, 
  ["Alta St"] = {
    door = 3,
     locked = true,
    pos = { x = 67.92 , y = -103.81 , z = 58.29, h = 64.94 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 67.94, y = -103.16 , z = 58.44, h = 66.67 }, -- The animation position
    doorTime = {}
   }
}
...
function OpenSellMenu()
  ...
  ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'pawn_sell_menu',
      {
          ...
          elements = {
              {label = 'Ring ($8500)', value = 'ring'},
              {label = 'Rolex ($8500)', value = 'rolex'},
              {label = 'Camera ($8500)', value = 'camera'},
              {label = 'Gold Necklace ($9500)', value = 'goldNecklace'},
              {label = 'Laptop ($8500)', value = 'laptop'},
              {label = 'Samsung S10($8500)', value = 'samsungS10'},
          }
      },
      function(data, menu)
