...
AddEventHandler('99kr-burglary:sellring', function()
	...
	for i=1, #xPlayer.inventory, 1 do
		...
		if ring > 0 then
			...
			xPlayer.addMoney(8500)
			TriggerClientEvent('esx:showNotification', xPlayer.source, "$8500 added")
		else 
...
AddEventHandler('99kr-burglary:sellgoldNecklace', function()
	...
	for i=1, #xPlayer.inventory, 1 do
		...
		if goldNecklace > 0 then
			...
			xPlayer.addMoney(9500)
			TriggerClientEvent('esx:showNotification', xPlayer.source, "$9500 added")
		else 
